...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 29, 2024 at 02:18 AM
...
(1602020601, 'ytyu', '01231341313', 'parseh'),
(1602021233, 'ytyu', '01231341313', 'pars'),
(2802085318, 'agus', 'ddfgg', '66666');
...
(5, '0000-00-00', 100000.00, 1602020601),
(6, '0000-00-00', 0.00, 1602021233),
(15, '0000-00-00', 1800.00, 2802085318);
...
(3, 'dika', 'petugas', 'afb91ef692fd08c445e8cb1bab2ccf9c', 2);
...
(1, 'sepatu', 300.00, 0),
(3, 'BONEKA', 50000.00, 3),
(6, 'dsgwuhd', 623662.00, 1),
(7, 'kaos kaki', 50000.00, 0);
...
--
ALTER TABLE `detailpenjualan`
  MODIFY `DetailID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `pelanggan`
--
ALTER TABLE `pelanggan`
  MODIFY `PelangganID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2802085319;
